...
class ArtifactsContainer implements ArtifactsContainerInterface
{
     ...
     */
    public function addApiRequest(string $requestIndex, \JsonSerializable $labelRequest): void
    {
        $this->apiRequests[$requestIndex] = $labelRequest;
    }
     ...
     *
     * @param string $requestIndex
     * @param ApiShipment $apiResponse
     */
    public function addApiResponse(string $requestIndex, ApiShipment $apiResponse): void
    {
