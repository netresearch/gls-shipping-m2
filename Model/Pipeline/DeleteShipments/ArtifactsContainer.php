...
class ArtifactsContainer implements ArtifactsContainerInterface
{
     ...
     */
    public function addApiRequest(string $requestIndex, string $shipmentNumber): void
    {
     ...
     * @param string $shipmentNumber
     */
    public function addApiResponse(string $requestIndex, string $shipmentNumber): void
    {
